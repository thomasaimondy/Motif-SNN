...
def main():
    ...
    parser.add_argument('--Mode', type=int, default=2, help='(default=%(default)d)')
    parser.add_argument('--path', type=str, default='20210918_20h01m47s_bp/20210918_20h01m47s_bp-0', help='(default=%(default)d)')

    timeclock = time.strftime("%Y%m%d_%Hh%Mm%Ss", time.localtime())
    args = parser.parse_args()
    args.codename = timeclock + '_' +args.codename + '-' +str(args.seed)
    print(args.codename)
    mkd(args)
