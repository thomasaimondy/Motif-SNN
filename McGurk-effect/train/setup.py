...
class MNISTTidigits(Dataset):
    def __init__(self, train_or_test, input_channel, n_bands, n_frames, transform=None, target_transform=None):
        ...
        # xx_train = counter_tid_train[0]+counter_tid_train[1]
        # yy_train = counter_tid_train[0]+counter_tid_train[1]+counter_tid_train[2]+counter_tid_train[3]
        # xx_test = counter_tid_test[0]+counter_tid_test[1]
        # yy_test = counter_tid_test[0] + counter_tid_test[1] + counter_tid_test[2] + counter_tid_test[3]
        # mnist_train_sample = mnist_train_sample[xx_train:yy_train,:]
        # mnist_train_label = mnist_train_label[xx_train:yy_train,]
        # mnist_test_sample = mnist_test_sample[xx_test:yy_test,:]
        # mnist_test_label = mnist_test_label[xx_test:yy_test]
        # train_set = list(train_set)
        # test_set = list(test_set)
        # val_set = list(val_set)
        # train_set[0] = train_set[0][xx_train:yy_train,:]
        # val_set[0] = val_set[0][xx_train:yy_train, :]
        # test_set[0] = test_set[0][xx_test:yy_test, :]
        # train_set[1] = train_set[1][xx_train:yy_train]
        # val_set[1] = val_set[1][xx_train:yy_train]
        # test_set[1] = test_set[1][xx_test:yy_test]
